	...
	.service('formatWeather', ['userTolerance', function(userTolerance){
		return {
            format: function (data) {
                ...
                if (feelsLike < userTolerance.customOutput('feelsLike',0) && feelsLike >= userTolerance.customOutput('feelsLike',-20)) {
                ...
                if (feelsLike < userTolerance.customOutput('feelsLike',15) && feelsLike >= userTolerance.customOutput('feelsLike',0)) {
                ...
                if (feelsLike < userTolerance.customOutput('feelsLike',32) && feelsLike >= userTolerance.customOutput('feelsLike',15)) {
                ...
                if (feelsLike < userTolerance.customOutput('feelsLike',40) && feelsLike >= userTolerance.customOutput('feelsLike',32)) {
